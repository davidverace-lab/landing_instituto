...
const DEFAULT_DATA: ProgressChartItem[] = [
  { name: 'CCI',           value: 50,  completados: 39,  total: 78,  color: Colors.skyBlue80,    logos: ['/logos/cci.svg'] },
  { name: 'EIT + ECV',     value: 100, completados: 298, total: 298, color: Colors.aquaGreen100, logos: ['/logos/eit.svg', '/logos/ecv.svg'] },
  { name: 'HP LOGISTICS',  value: 100, completados: 10,  total: 10,  color: Colors.seaBlue80,    logos: ['/logos/hp-logistics.svg'] },
  { name: 'HP MÉXICO',     value: 96,  completados: 153, total: 159, color: Colors.sunrayYellow100, logos: ['/logos/hutchisonports.webp'] },
  { name: 'ICAVE',         value: 100, completados: 342, total: 342, color: Colors.sunsetOrange100, logos: ['/logos/icave.svg'] },
  { name: 'LCMT + LCT',    value: 99,  completados: 220, total: 223, color: Colors.seaBlue100,   logos: ['/logos/lcmt.svg', '/logos/lct.svg'] },
  { name: 'TILH',          value: 100, completados: 67,  total: 67,  color: Colors.aquaGreen100, logos: ['/logos/tilh.svg'] },
  { name: 'TIMSA',         value: 100, completados: 187, total: 187, color: Colors.sunsetOrange100, logos: ['/logos/timsa.svg'] },
