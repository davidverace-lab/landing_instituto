...
export default function CountdownUnit({ value, label, labelColor = 'text-sky-brand' }: Props) {
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        className="relative flex items-center justify-center w-20 h-20 md:w-28 md:h-28 bg-navy-dark border border-sky-brand/30"
        style={{ boxShadow: 'inset 0 1px 0 rgba(0,159,227,0.15)' }}
      >
        <span
          className="font-verlag text-4xl md:text-5xl text-white tabular-nums"
